...
//       "SELECT phone, pending_commission FROM users WHERE pending_commission > 0"
//     );
...
//     await connection.query(
//       "UPDATE users SET money = money + pending_commission, pending_commission = 0 WHERE pending_commission > 0"
//     );
...
//     console.log("Trade commission processed");

//     return res.json({
//       status: true,
//       message: "Trade commission processed",
//       users: users.length
//     });

//   } catch (err) {

//     console.error("tradeCommission error:", err);
