...
// const vipLevelMonthly = async () => {

//   try {

//     const sumdate = timerJoin2(Date.now());

//     const [vipdata] = await connection.query("SELECT monthstime FROM vip_data");

//     const [users] = await connection.query(
//       "SELECT phone, vip_level FROM users WHERE vip_level BETWEEN 1 AND 10"
//     );
...
//       const bonus = vipdata[user.vip_level - 1].monthstime;
...
//     if (vipValues.length) {
//       await connection.query(
//         "INSERT INTO vip_record (phone, amount, level, type, date) VALUES ?",
//         [vipValues]
//       );
//     }

//     console.log("VIP monthly processed");

//   } catch (err) {
//     console.error("VIP cron error:", err);
//   }
