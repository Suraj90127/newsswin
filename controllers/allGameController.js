...
const checkBalance = async (req, res) => {
  try {
    ...
    const response = await axios.post(`${apiUrl}/Userbalance?key=${key}`, {
      playerid,
      key,
    },
    {
...
const transferBalance = async (req, res) => {
  try {
    ...
    const responses = await axios.post(`${apiUrl}/Userbalance?key=${key}`, {
      playerid,
      key,
    },
    {
    ...
    // Call the `/games/open` API
    const response = await axios.post(`${apiUrl}/Setbalance?key=${key}`, {
      playerid,
      key,
...
const getgamedetails = async (req, res) => {
  try {
   ...
   const response = await axios.get(`${apiUrl}/getgamedetails`, {
      params: {
        key,
        page,
        size,
...
const gameProvider = async (req, res) => {
  try {
    const response = await axios.get(
      `${apiUrl}/getgamedetails?key=${key}&provider_list=1`,
        {
    headers: commonHeaders,
    withCredentials: true,
  }
...
const gameType = async (req, res) => {
  try {
    const response = await axios.get(
      `${apiUrl}/getgamedetails?key=${key}&gametype_list=1`,
        {
    headers: commonHeaders,
    withCredentials: true,
  }
...
const gameListByGameType = async (req, res) => {
  try {
    ...
    const response = await axios.get(
      `${apiUrl}/getgamedetails?key=${key}`,
      {
        params: {
        key: key, // apna actual key variable
        provider: game_type,
        page,
        size,
        },
    ...
    console.error("kya error hai", error?.response?.data || error.message);
...
//     const response = await axios.get(
//       `${apiUrl}/getgamedetails?key=${key}&game_type=${game_type}&page=${page}&size=${size}`,
//     );
...
//   } catch (error) {
//     console.error("kya error hai",error);
//     return res.status(500).json({
//       message: "Internal server error",
//       status: false,
//       error: error.message,
...
const gameHistory = async (req, res) => {
  try {
    ...
    const response = await axios.post(`${apiUrl}/history?key=${key}`, payload,
        {
    headers: commonHeaders,
    withCredentials: true,
  });
