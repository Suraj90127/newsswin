...
const PaymentPage = () => {
  ...
  useEffect(() => {
    dispatch(rechargeGet()).then((res) => {
      ...
      setTypeid(res?.payload?.id_order || "");
    });
  }, [dispatch]);
  ...
  const paymentMethods = [
    ...
    },
    {
      id: "mobiKwik",
      name: "MobiKwik",
      imageSrc: "https://i.ibb.co/FzNz0W8/mobilekwik.png",
    },
    {
      id: "upi",
      name: "UPI",
        ...
        <div className="w-full border border-slate-600 p-4 rounded-lg">
          ...
          <div className="border border-gray-600 mt-3 p-4 rounded-lg">
            <h1 className="text-black font-semibold text-center py-4 text-3xl">
              ₹{Number(rechargegetData?.money || 0).toFixed(2)}
            </h1>
            ...
            <ul className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              {paymentMethods.map((method) => (
                <li
                  ...
                  className={`flex items-center p-3 border border-gray-600 rounded-lg cursor-pointer transition-colors ${
          ...
          <div className="flex flex-col items-center bg-white p-4 rounded-lg w-full">
            ...
            <div className="mb-4 w-full">
              <div className="relative flex items-center">
                <input
                  ...
                  readOnly
                  placeholder="upi"
                  className="w-full p-2 pr-16 text-black border border-gray-300 rounded-lg"
            ...
            <form onSubmit={handleSubmit} className="w-full">
              <input
                ...
                className="w-full p-2 mb-3 text-black border border-gray-300 rounded-lg"
