...
router.get("/api/webapi/promotioncron", async (req,res)=>{
  res.json({status:true,message:"Cron started"});

  setImmediate(async () => {
    try {
      await commissionController.promotion();
      console.log("promotion cron done");
    } catch (err) {
...
router.get("/api/webapi/downlinerecharge_newcron", async (req,res)=>{
  res.json({status:true,message:"Cron started"});
...
router.get("/api/webapi/tradeCommissioncron", async (req,res)=>{

   res.json({
     status:true,
     message:"Trade commission cron started"
   });

   winGoController.tradeCommission();

});
router.get("/api/webapi/vipLevelMonthlycron", async (req,res)=>{
   res.json({status:true,message:"vip cron started"});
